Rotation. 
Concevez puis réalisez une application qui affiche dans une fenêtre un triangle bleu pointant vers le haut. Chaque clic dans la fenêtre fera faire un quart de tour au triangle.
...
Coloration. 
Dans l'application Mag8, les réponses possibles appartiennent à trois catégories : positives (les 10 premières), évasives (les 5 suivantes), et négatives (les 5 dernières).
...
Compétition. 
Concevez puis réalisez une application qui affiche les cinq meilleurs temps (ces temps ne seront pas mémorisés d'une session à l'autre). Un bouton jouer permettra de lancer une partie dans une nouvelle fenêtre.
